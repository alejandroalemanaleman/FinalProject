...
<img width="650" src="https://github.com/alejandroalemanaleman/Memoria/assets/145342887/840d5d1a-37c5-4c38-bec6-cdf638b8db22">


## Summary of Functionality

This program is designed to recieve data from two sources. Firstly, hotel-provider, is responsable to retrivve periodically hotel data of the 8 Canary Islands from the TripAdvisor web page, including details such as the name, place, price range per night and rating. 
